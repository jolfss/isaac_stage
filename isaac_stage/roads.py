...
def main():    
    ...
    terrain = ForestedRoadsTerrain(terrain_unit=dim/200, xdim=dim, ydim=dim, road_min_width=3, road_max_width=3, road_num=12
                                   ,applier=apply_appliers([apply_default_ground_physics_material, lambda prim_path : apply_color_to_prim(prim_path, color=(0.35,0.31,0.25))]))
    ...
    # build stage
    environment.build_stage(global_offset=[0,0,0],spawn_assets=True,asset_density=0.5)  
